...
4. docs/event-model.md
5. docs/review-layer.md
6. docs/allocation-layer.md
7. spec/royalty-os-v0.2.yaml
8. examples/value-event-log.example.yaml
9. schemas/royalty-os-record.schema.json
```

This order moves from overview to version relationship, architecture, event model, review, allocation, specification, examples, and validation.
